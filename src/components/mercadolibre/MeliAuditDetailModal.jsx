  ...
  return (
        ...
        <>
          {item.permalink && (
            <a 
              ...
              target="_blank" 
              rel="noreferrer"
              className="mr-auto inline-flex items-center gap-1.5 text-xs text-[#141413] hover:underline font-bold"
            >
    ...
    >
      <div className="flex flex-col gap-5 text-xs">
        ...
        <div className="grid grid-cols-2 gap-3 bg-[#faf9f5] border border-[#e5e3dc] rounded-2xl p-4">
          <div>
            <span className="text-[10.5px] font-bold text-[#73726c] uppercase tracking-wider block">
              Precio Publicado en ML
            </span>
            <span className="text-xl font-black font-mono text-[#141413]">
        ...
        <div className="flex flex-col gap-2">
          <h4 className="text-[11px] font-bold text-[#73726c] uppercase tracking-wider">
            Desglose de Deducciones y Cargos de Mercado Libre
          </h4>
          <div className="border border-[#e5e3dc] rounded-2xl divide-y divide-[#ece9df] overflow-hidden">
            {/* Comisión */}
            <div className="p-3.5 flex items-center justify-between hover:bg-[#faf9f5]/50 transition-colors">
              <div className="flex items-center gap-2.5">
                <div className="p-1.5 bg-[#f4f2eb] text-[#141413] rounded-lg border border-[#e5e3dc]">
                ...
                <div>
                  ...
                  <span className="text-[10px] text-[#73726c]">Porcentaje por categoría oficial</span>
                </div>
              </div>
              <span className="font-bold font-mono text-[#b91c1c] text-sm">
            ...
            <div className="p-3.5 flex items-center justify-between hover:bg-[#faf9f5]/50 transition-colors">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  ...
                  <span className="text-[10px] text-[#73726c]">Con bonificación de reputación aplicada</span>
                </div>
              </div>
              <span className="font-bold font-mono text-[#b91c1c] text-sm">
            ...
            <div className="p-3.5 flex items-center justify-between hover:bg-[#faf9f5]/50 transition-colors">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  ...
                  <span className="text-[10px] text-[#73726c]">IIBB / Percepciones estimadas</span>
                </div>
              </div>
              <span className="font-bold font-mono text-[#b91c1c] text-sm">
            ...
            {item.cargo_fijo > 0 && (
              <div className="p-3.5 flex items-center justify-between hover:bg-[#faf9f5]/50 transition-colors">
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    <span className="font-bold text-[#141413] block">Cargo Fijo por Ítem</span>
                    <span className="text-[10px] text-[#73726c]">Para publicaciones de bajo monto</span>
                  </div>
                </div>
                <span className="font-bold font-mono text-[#b91c1c] text-sm">
        ...
        <div className="bg-[#faf9f5] border border-[#e5e3dc] rounded-2xl p-4 flex flex-col gap-2.5">
          <span className="text-[11px] font-bold text-[#141413] uppercase tracking-wider">
            Comparativa de Rentabilidad ERP
          </span>
          <div className="flex items-center justify-between text-xs">
            <span className="text-[#73726c] font-medium">Precio Mostrador ERP Esperado:</span>
          ...
          <div className="flex items-center justify-between text-xs pt-2 border-t border-[#ece9df]">
            <span className="text-[#73726c] font-medium">Diferencia Neta en Mano:</span>
            <div className="flex items-center gap-2 font-mono">
              <span className={`font-black text-sm ${
                item.diferencia_vs_mostrador >= 0 ? 'text-[#15803d]' : 'text-[#b91c1c]'
              }`}>
